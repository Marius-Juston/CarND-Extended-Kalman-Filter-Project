 ...
 public:
  ...
  void conservativeResize(Index rows, Index cols) {
    ...
    if (m_innerNonZeros) {
      ...
      Index *newInnerNonZeros =
          static_cast<Index *>(std::realloc(m_innerNonZeros, (m_outerSize + outerChange) * sizeof(Index)));
    ...
    Index *newOuterIndex =
        static_cast<Index *>(std::realloc(m_outerIndex, (m_outerSize + outerChange + 1) * sizeof(Index)));
    if (!newOuterIndex) internal::throw_std_bad_alloc();
