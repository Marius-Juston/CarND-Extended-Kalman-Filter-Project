...
class AlignedBox {
 public:
  ...
  /** \returns the lengths of the sides of the bounding box.
    ...
    */
  inline const CwiseBinaryOp<internal::scalar_difference_op<Scalar>, const VectorType,
  ...
  /** \returns an expression for the bounding box diagonal vector
    ...
    * will provide it.
    */
  inline CwiseBinaryOp<internal::scalar_difference_op<Scalar>, const VectorType,
                                                               const VectorType> diagonal() const { return sizes(); }
  ...
  inline AlignedBox intersection(const AlignedBox &b) const {
    return AlignedBox(m_min.cwiseMax(b.m_min),
                      m_max.cwiseMin(b.m_max));
  }
  ...
  inline AlignedBox merged(const AlignedBox &b) const {
    return AlignedBox(m_min.cwiseMin(b.m_min),
                      m_max.cwiseMax(b.m_max));
  }
