...
struct TriangularProduct<Mode, true, Lhs, false, Rhs, true>
  ...
  void scaleAndAddTo(Dest &dst, const Scalar &alpha) const {
    ...
    internal::trmv_selector<(int(internal::traits<Lhs>::Flags) & RowMajorBit) ? RowMajor : ColMajor>::run(*this,
                                                                                                          dst,
                                                                                                          alpha);
  }
};
...
struct trmv_selector<ColMajor> {
  ...
  static void run(const TriangularProduct<Mode, true, Lhs, false, Rhs, true> &prod,
                  Dest &dest,
