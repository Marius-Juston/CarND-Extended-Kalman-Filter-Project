...
EIGEN_DONT_INLINE void selfadjoint_matrix_vector_product<Scalar,
  ...
  conj_helper<Packet, Packet, NumTraits<Scalar>::IsComplex && EIGEN_LOGICAL_XOR(ConjugateLhs, IsRowMajor), ConjugateRhs>
      pcj0;
  conj_helper<Packet,
              Packet,
              NumTraits<Scalar>::IsComplex && EIGEN_LOGICAL_XOR(ConjugateLhs, !IsRowMajor),
...
struct SelfadjointProductMatrix<Lhs, LhsMode, false, Rhs, 0, true>
  ...
  void scaleAndAddTo(Dest &dest, const Scalar &alpha) const {
    ...
    internal::gemv_static_vector_if<ResScalar, Dest::SizeAtCompileTime, Dest::MaxSizeAtCompileTime, !EvalToDest>
        static_dest;
    internal::gemv_static_vector_if<RhsScalar, _ActualRhsType::SizeAtCompileTime, _ActualRhsType::MaxSizeAtCompileTime,
        !UseRhs> static_rhs;
    ...
    internal::selfadjoint_matrix_vector_product<Scalar,
                                                Index,
                                                (internal::traits<_ActualLhsType>::Flags & RowMajorBit) ? RowMajor
                                                                                                        : ColMajor,
                                                int(LhsUpLo),
...
struct SelfadjointProductMatrix<Lhs, 0, true, Rhs, RhsMode, false>
  ...
  void scaleAndAddTo(Dest &dest, const Scalar &alpha) const {
    ...
    SelfadjointProductMatrix<Transpose<const Rhs>, int(RhsUpLo) == Upper ? Lower : Upper, false,
                             Transpose<const Lhs>, 0, true>(m_rhs.transpose(), m_lhs.transpose()).scaleAndAddTo(destT,
                                                                                                                alpha);
  }
};
