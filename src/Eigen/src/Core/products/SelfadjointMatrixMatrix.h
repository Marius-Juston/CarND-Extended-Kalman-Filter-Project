...
EIGEN_DONT_INLINE void product_selfadjoint_matrix<Scalar,
  ...
  gemm_pack_lhs<Scalar, Index, Traits::mr, Traits::LhsProgress, LhsStorageOrder == RowMajor ? ColMajor : RowMajor, true>
      pack_lhs_transposed;
