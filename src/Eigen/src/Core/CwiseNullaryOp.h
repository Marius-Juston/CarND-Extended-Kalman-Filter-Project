...
DenseBase<Derived>::Constant(const Scalar &value) {
  ...
  return DenseBase<Derived>::NullaryExpr(RowsAtCompileTime,
                                         ColsAtCompileTime,
...
/** \returns an expression of the i-th unit (basis) vector.
  ...
  */
template<typename Derived>
EIGEN_STRONG_INLINE const typename MatrixBase<Derived>::BasisReturnType MatrixBase<Derived>::Unit(Index newSize,
                                                                                                  Index i) {
  EIGEN_STATIC_ASSERT_VECTOR_ONLY(Derived)
