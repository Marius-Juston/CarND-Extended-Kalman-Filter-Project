...
class SparseLU : public internal::SparseLUImpl<typename _MatrixType::Scalar, typename _MatrixType::Index> {
 ...
 public:
  ...
  /** \returns an expression of the matrix U,
    ...
    * \endcode
    */
  SparseLUMatrixUReturnType<SCMatrix, MappedSparseMatrix < Scalar, ColMajor, Index> >
  matrixU() const {
...
void SparseLU<MatrixType, OrderingType>::factorize(const MatrixType &matrix) {
  ...
  new(&m_Ustore) MappedSparseMatrix<Scalar, ColMajor, Index>(m,
                                                             n,
                                                             m_nnzU,
                                                             m_glu.xusub.data(),
                                                             m_glu.usub.data(),
  ...
  void solveInPlace(MatrixBase<Dest> &X) const {
    ...
    for (Index k = m_mapL.nsuper(); k >= 0; k--) {
      ...
      if (nsupc == 1) {
        ...
        Map<Matrix<Scalar, Dynamic, Dynamic, ColMajor>, 0, OuterStride<> >
